...
1. API client interpretation in Swift for yelp was really confusing to understand.
2.
...
![Alt Text](https://github.com/SamuelSanchezA/CST-495-Yelp/blob/master/assignment-3.gif)
